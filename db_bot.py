...
questions = [
    "What guitars are in stock?",
    "What is the average price of electric guitars?",
    "who bought guitars this month?",
    "What is the most expensive guitar?",
    "Which staff member have done the most repairs?",
    "What customer spent the most money?",
    "Which guitar brand is the most popular based on sales?",
    "How many guitars were repaired this year?",
    "What is the total guitar sales revenue?"
]
